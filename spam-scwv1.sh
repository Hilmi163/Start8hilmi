...
echo
echo
echo $cyan"1.)Spam Whatsapp by Hilmi163"
echo
echo $red"2.)Spam Call by ridwanszz15"
echo
echo $blue"3.)Spam Sms by Hilmi163"
echo
echo $red"0.)Keluar"
echo
echo $white
...
sleep 3
git clone https://github.com/Hilmi163/spam-whatsapp
sleep 2
cd spam-whatsapp
sleep 2
...
echo
git clone https://github.com/Hilmi163/spam-sms
sleep 2
cd spam-sms
sleep 2
pip2 install requests
